...
public:
  ...
  struct Config {
    ...
    void printCostWeight() const {
      ...
      std::cout << "x_weights: " << cost_weight.x_weights.transpose()
                << std::endl;
      std::cout << "control_weight: " << cost_weight.control_weight
                << std::endl;
      std::cout << "com_track_weight: " << cost_weight.com_track_weight
                << std::endl;
      std::cout << "centroidal_momentum_weight: "
                << cost_weight.centroidal_momentum_weight << std::endl;
      std::cout << "foot_track_weight: " << cost_weight.foot_track_weight
                << std::endl;
      std::cout << "contact_wrench_weight: "
                << cost_weight.contact_wrench_weight << std::endl;
    }
  };
...
private:
  ...
  void solveProblem(int max_iter, bool verbose,
